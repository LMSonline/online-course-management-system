                ...
                <table className="w-full">
                    ...
                    <tbody className="divide-y divide-white/5">
                        {configs.map((config) => {
                            ...
                            const teacherPercentage = config.percentage;
                            const platformPercentage = 100 - teacherPercentage;
                                ...
                                >
                                    ...
                                    >
                                        <div className="flex items-center justify-end gap-2">
                                            ...
                                            <button
                                                disabled={isDeleting || config.isActive}
                                                onClick={(e) => {
                                                    e.stopPropagation();

                                                    if (config.isActive) {
                                                        toast.warning(
                                                            "You must deactivate this revenue share configuration before deleting."
                                                        );
                                                        return;
                                                    }
