// src/core/components/admin/reports/AdminInstructorPerformanceTable.tsx
import type { InstructorPerformanceSummary } from "@/lib/admin/types";

type Props = {
  items: InstructorPerformanceSummary[];
};

export function AdminInstructorPerformanceTable({ items }: Props) {
  return (
