...
export function AdminReportsCharts({ monthly }: Props) {
  return (
    <section className="grid gap-4 lg:grid-cols-2">
      ...
      <div className="rounded-2xl border border-white/10 bg-slate-950/90 p-4 md:p-5 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <p className="text-[11px] text-slate-400">
            Use this as base for financial reports.
          </p>
        </div>
      ...
      <div className="rounded-2xl border border-white/10 bg-slate-950/90 p-4 md:p-5 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <p className="text-[11px] text-slate-400">
            Correlation between sign-ups and active learners.
          </p>
        </div>
        <div className="h-52 md:h-64">
          <ResponsiveContainer width="100%" height="100%">
