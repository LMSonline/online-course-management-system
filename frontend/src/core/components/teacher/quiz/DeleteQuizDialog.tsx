            ...
            <AlertDialogContent className="max-w-md bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800">
                <AlertDialogHeader>
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <AlertDialogTitle className="text-lg text-slate-900 dark:text-white">Delete Quiz</AlertDialogTitle>
                ...
                <div className="p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50 rounded-xl">
                    <p className="text-sm text-amber-800 dark:text-amber-200">
                        <strong>Warning:</strong> If students have already attempted this quiz, deletion may fail. All quiz data will be permanently removed.
                    </p>
                </div>
