// src/core/components/instructor/dashboard/CoursesPerformanceTable.tsx
import { MoreHorizontal } from "lucide-react";
import type { InstructorCourseSummary } from "@/lib/instructor/dashboard/types";

type Props = {
  courses: InstructorCourseSummary[];
};

const statusColor: Record<InstructorCourseSummary["status"], string> = {
