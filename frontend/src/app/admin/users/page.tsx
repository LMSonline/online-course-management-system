...
import { Users, Lock, Unlock, MoreVertical, Search, BarChart3 } from "lucide-react";
import {
  useGetAllAccounts,
  useSuspendAccount,
  useUnlockAccount,
...
export default function AdminUsersScreen() {
  ...
  // Lấy page và size từ URL query params
  ...
  // Nếu đang ở chế độ xem thống kê, chỉ render màn hình thống kê
  if (showStatsView) {
    return (
      <div className=" min-h-screen bg-[#0a1123]">
        {/* <button
          className="fixed top-4 right-4 z-50 bg-[#1a2237] text-white px-4 py-2 rounded-lg border border-gray-700 hover:bg-[#242d45]"
    ...
    <div className="space-y-6 container mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3 ml-auto">
          <button
            className="px-4 py-2 bg-[#1a2237] hover:bg-[#242d45] border border-gray-800 text-white rounded-lg font-medium transition-colors flex items-center gap-2"
          ...
          <button
            className="px-4 py-2 bg-[#00ff00] hover:bg-[#00dd00] text-black rounded-lg font-medium transition-colors flex items-center gap-2"
