...
export default function QnAPage() {
    ...
    const courses = teacherCoursesHook.courses || [];
    ...
    // Fetch statistics
    const { data: stats } = useCommentStatistics(selectedCourseId);

    // Determine which data to show
    const questions = keyword.trim()
        ? searchData
                        ...
                        <div className="bg-white rounded-lg p-4 border">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-yellow-600">{stats.unansweredQuestions || 0}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-lg border p-4 sticky top-6">
                            ...
                            <div className="space-y-2">
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2 rounded-md transition-colors ${activeTab === "unanswered"
                                ...
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2 rounded-md transition-colors ${activeTab === "popular"
                                        ? "bg-blue-100 text-blue-700 font-medium"
                                        : "hover:bg-gray-100"
                                        }`}
                                >
