// src/lib/instructor/course-management/types.ts
...
export type CurriculumItemType = "lecture" | "quiz" | "assignment" | "question-bank";
...
export type InstructorCourseManage = {
  id: string;
  title: string;
...
export const MOCK_INSTRUCTOR_COURSE_MANAGE: InstructorCourseManage = {
  id: "c1",
